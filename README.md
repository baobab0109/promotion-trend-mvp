...
- 주간/최근 기간 선택: `public/data/weeks.json` 기반 최신 주차 기본값, 최근 7/14/30일, 최근 4/8주 합산 선택
...
- 주간 트렌드 요약 카드
- 기간 선택 패널: 기본값은 `주간 > 최신 주차`, 필요 시 최근 7일 / 최근 14일 / 최근 30일 / 최신 주차·직전 주·최근 4/8주 합산 드롭다운으로 전환
