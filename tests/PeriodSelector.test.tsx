...
const model: PeriodControlModel = {
  ...
  weeklyOptions: [
    { value: 'latest', label: '최신 주차 · 2026.06.17 - 2026.06.23', description: '최신 주차', files: ['./data/trends/2026-W25.json'] },
...
describe('PeriodSelector', () => {
  ...
  it('shows weekly choices and emits selection changes in weekly mode', async () => {
    ...
    render(<PeriodSelector model={model} preset="weekly" weeklyValue="latest" activeLabel="최신 주차" loading={false} onPresetChange={() => {}} onWeeklyValueChange={onWeeklyValueChange} />);
